...
public static class RegisterAndCheckVersion
{
    private static void Prefix(ZNetPeer peer, ref ZNet __instance)
    {
        ...
        zpackage.Write(PvPAlwaysPlugin.ModVersion);
        peer.m_rpc.Invoke("PvPAlwaysOn_VersionCheck", zpackage);
    }
}
    ...
    public static void RPC_PvPAlwaysOn_Version(ZRpc rpc, ZPackage pkg)
    {
        ...
        else
        {
            if (!ZNet.instance.IsServer())
            {
                ...
                PvPAlwaysPlugin.PvPAlwaysLogger.LogInfo("Received same version from server!");
            }
            else
            {
